    ...
    axios
      ...
      .then((res) => {
        return (
          ...
          console.log("siteName", res.data.details)
        );
      })
              ...
              {data2?.map((a, b) => {
                ...
                return (
                  <StyledTableRow key={b}>
                    ...
                    <StyledTableCell sx={{ width: 400 }} align="start">
                      {remarks?.map((log) => (
                        <>
                          <p className="grid mt-1 grid-cols-3">
                            <span className="w-[200px]">Date:{log?.date}</span>
                    ...
                    <StyledTableCell sx={{ paddingX: 0 }} align="center">
                      <Button
                        ...
                        variant="contained">
                        <Link
                          to={`/downloadengineerchallanpdf/${a?.engiRetChallan}?type=externalReturnableChallan`}
                          target="_blank"
                          className={`${
                    ...
                    <StyledTableCell sx={{ paddingX: 0 }} align="center">
                      <Button
                        ...
                        variant="contained">
                        <Link
                          to={`/thirdpartychallan-non-return/${a?.thirdPartyNonRetChallan}?type=thirdPartyNonReturnableChallan`}
                          target="_blank"
                          className={`${
                    ...
                    <StyledTableCell sx={{ paddingX: 0 }} align="center">
                      <Button
                        ...
                        variant="contained">
                        <Link
                          to={`/thirdpartychallanpdf/${a?.thirdPartyRetChallan}?type=thirdPartyReturnableChallan`}
                          target="_blank"
                          className={`${
                    ...
                    <StyledTableCell sx={{ paddingX: 0 }} align="center">
                      <Button
                        ...
                        variant="contained">
                        <Link
                          to={`/downloadchallanpdf/${a?.prodIntRetChallan}?type=internalReturnableChallan`}
                          target="_blank"
                          className={`${
                    ...
                    <StyledTableCell sx={{ paddingX: 0 }} align="center">
                      <Button
                        ...
                        variant="contained">
                        <Link
                          to={`/downloadproductionchallanpdf/${a?.prodIntNonRetChallan}?type=internalNonReturnableChallan`}
                          target="_blank"
                          className={`${
