...
//     axios
//       .post(
//         `${window.MyApiRoute}record/get?category=3-phaseMeter&location=getChallanDetails&challanType=internal returnable challan`,
//         data
//       )
//       .then((res) => {
...
//       {data2
//         ?.filter((searchs) =>
//           searchs?.challanNumber.toString().includes(search)
//         )
//         .map((item, index) => {
//           return (
//             <>
...
//                               <StyledTableCell align="center">
//                                 <Link
//                                   to={`/downloadchallanpdf/${challan.challanNumber}?type=internalReturnableChallan`}
//                                   target="_blank"
